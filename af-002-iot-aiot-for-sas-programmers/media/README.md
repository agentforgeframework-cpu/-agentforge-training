...
VisualBrief images provide:
- quick lesson orientation
...
# Approved vs Generated Media

AF-002 distinguishes between:
- generated media
- approved instructional media
- sourced instructional media
- historical/testing artifacts
...
The media practices used in AF-002 currently represent:
- operational guidance
- survivability guidance
- release-engineering guidance

rather than formal governance doctrine.
